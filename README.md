...
|-------|------:|------:|--------|
| Backend unit (pytest) | 297 | 5,200 | All pass |
...
| [Test Plan](http://localhost:3001/docs/test-plan.html) | `/docs/test-plan.html` | 328 tests, pass rates, coverage |
