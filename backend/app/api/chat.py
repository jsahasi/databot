...
async def generate_suggestions(
    ...
    if agent_used == "concierge":
        system_prompt = (
            ...
            "CRITICAL: suggestions must be ACTIONABLE CHOICES the user can click, NOT steps from the answer. "
            "Never turn numbered instructions (step 1, step 2) into chips. "
            "Good: 'Can I change the SFA video quality?' Bad: 'Go to your event in Elite' "
